...
This document is my learning process as a data engineer. Below is a summary of my learning process and a file introduction:
...
2. Map folder: This is what I encountered when I started using the Google Places API. I began to understand the API's fee and how to plan my program writing based on the free quota. I encountered many problems that I hadn't anticipated. 
